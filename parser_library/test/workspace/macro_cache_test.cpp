...
TEST(macro_cache_test, copy_from_macro)
{
    ...
    macro_cache_key macro_key { ids, { processing::processing_kind::MACRO, macro_id }, {} };
    macro_cache_key copy_key { ids, { processing::processing_kind::COPY, copy_id }, {} };
...
TEST(macro_cache_test, opsyn_change)
{
    ...
    macro_cache_key macro_key { ids, { processing::processing_kind::MACRO, macro_id }, {} };
    macro_cache_key macro_key_one_opsyn { ids,
