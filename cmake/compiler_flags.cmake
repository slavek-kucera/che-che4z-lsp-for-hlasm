...
if(APPLE)
  if(WITH_STATIC_CRT)
    ...
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -nostdlib -nostdlib++ -lSystem ${libcppabi_file} ${libcpp_file}")
    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} -nostdlib -nostdlib++ -lSystem ${libcppabi_file} ${libcpp_file}")
  endif()
endif()
